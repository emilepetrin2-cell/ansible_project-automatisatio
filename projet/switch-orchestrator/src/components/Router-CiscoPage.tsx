  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl">
        <h2 className="text-sm font-mono uppercase text-blue-400 mb-4 border-b border-slate-800 pb-2">?? Playbook Modules Activation</h2>
      ...
      {(triggerHardening || triggerBaseServices) && (
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {triggerBaseServices && (
            <div className="space-y-4">
              <h3 className="text-xs font-mono uppercase text-cyan-400 border-b border-slate-800 pb-1">??? System Services (M3)</h3>
              <div className="grid grid-cols-2 gap-2">
                <div>
      ...
      {triggerAcls && (
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl space-y-6">
          <h2 className="text-sm font-mono uppercase text-blue-400 border-b border-slate-800 pb-2">??? Extended ACL Builder & Binding (M7)</h2>
      ...
      <footer className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex items-center justify-between shadow-2xl">
        <span className="text-xs text-slate-400">
          {userRole === "auditor" ? (
            <span className="text-amber-400 font-bold">??? Mode Audit (Lecture Seule)</span>
          ) : (
